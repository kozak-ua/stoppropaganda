...
ADD ./* /go/src/github.com/kozak-ua/stoppropaganda/
WORKDIR /go/src/github.com/kozak-ua/stoppropaganda
...
WORKDIR /app
COPY --from=build-env /go/src/github.com/kozak-ua/stoppropaganda/stoppropaganda /app/
